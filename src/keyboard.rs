...
impl Keyboard {
    ...
    fn transform_device_key(device_key: &dq::Keycode) -> Key {
        match device_key {
            ...
            dq::Keycode::Numpad0 => Key::Numpad0,
            dq::Keycode::Numpad1 => Key::Numpad1,
            dq::Keycode::Numpad2 => Key::Numpad2,
            dq::Keycode::Numpad3 => Key::Numpad3,
            dq::Keycode::Numpad4 => Key::Numpad4,
            dq::Keycode::Numpad5 => Key::Numpad5,
            dq::Keycode::Numpad6 => Key::Numpad6,
            dq::Keycode::Numpad7 => Key::Numpad7,
            dq::Keycode::Numpad8 => Key::Numpad8,
            dq::Keycode::Numpad9 => Key::Numpad9,
